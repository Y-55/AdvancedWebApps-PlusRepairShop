...
public class AddFeedbackEntry extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String Subject = request.getParameter("Subject");//casting from string to integer
            String Type = request.getParameter("Type");//casting from string to integer
            ...
            int k = db.insertIntoFeedbacks(Name, Country, Phone, Email, Subject, Type, Message);;     // returns number of affected rows
